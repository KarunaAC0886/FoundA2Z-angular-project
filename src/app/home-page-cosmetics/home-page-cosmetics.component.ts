...
@Component({
  selector: 'app-home-page-cosmetics',
  templateUrl: './home-page-cosmetics.component.html',
  styleUrls: ['./home-page-cosmetics.component.css']
})
export class HomePageCosmeticsComponent implements OnInit,OnDestroy {
